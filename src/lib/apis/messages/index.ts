...
export const updateMessageById = async (token: string = '', message_id: string, message: object) => {
  let error = null;
...
export const chatCompletion = async (token: string = '', body: object): Promise<[Response | null, AbortController]> => {
